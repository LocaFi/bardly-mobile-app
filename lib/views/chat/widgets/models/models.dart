...
import 'package:bardly_mobile_app/views/chat/widgets/message_container.dart';
import 'package:bardly_mobile_app/views/chat/widgets/text_container.dart';
...
class ActionMessage extends Message {
  final String text;
  ActionMessage({required super.author, required super.time, required this.text});
...
class DocumentMessage extends Message {
  ...
  DocumentMessage({required super.author, required super.time, super.stage, required this.documentSize, required this.documentFormat, required this.documentName});
...
class ImageMessage extends Message {
  ...
  final void Function(double)? onCompleted;

  ImageMessage({required this.onCompleted, required super.author, required super.time, super.stage, required this.imageUrl, this.caption});
      ...
      children: [
            ...
            child: ClipRRect(
              ...
              child: CachedNetworkImage(
                progressIndicatorBuilder: (context, url, progress) {
                  if (onCompleted != null && progress.progress != null) {
                    WidgetsBinding.instance.addPostFrameCallback((_) {
                      onCompleted!(progress.progress!);
                    });
                  }
        ...
        caption != null
            ? Padding(
                ...
                child: TextContainer(
                  text: caption!,
                  style: author == loggedInUser ? theme.outwardMessageTextStyle : theme.inwardMessageTextStyle,
...
class TextMessage extends Message {
  ...
  TextMessage({this.isLoading = false, required super.author, required super.time, super.stage = 0, required this.text});
