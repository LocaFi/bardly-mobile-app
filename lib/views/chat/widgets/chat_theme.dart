import 'package:bardly_mobile_app/views/chat/widgets/status_builder.dart';
...
class DefaultChatTheme extends ChatTheme {
  DefaultChatTheme(
      ...
      super.backgroundImage = const DecorationImage(
        image: CachedNetworkImageProvider("https://i.pinimg.com/736x/85/ec/df/85ecdf1c3611ecc9b7fa85282d9526e0.jpg"),
        fit: BoxFit.cover,
      ),
      ...
      super.linkPreviewTitleStyle = const TextStyle(color: Colors.white, fontWeight: FontWeight.bold),
      super.linkPreviewTextStyle = const TextStyle(
        color: Color.fromARGB(255, 182, 182, 182),
      ),
      super.bodyPadding = const EdgeInsets.symmetric(vertical: 10, horizontal: 20),
      ...
      super.avatarTextStyle = const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 22, fontFamily: 'Satoshi'),
      ...
      super.actionMessageMargin = const EdgeInsets.only(top: 15, left: 20, right: 20),
