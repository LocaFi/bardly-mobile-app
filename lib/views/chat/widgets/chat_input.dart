...
import 'package:bardly_mobile_app/views/chat/widgets/models/icons.dart';
...
class ChatInput extends StatefulWidget {
  const ChatInput({Key? key, this.onSend, this.user, this.padding}) : super(key: key);
...
class _ChatInputState extends State<ChatInput> {
  ...
  onSendClick() {
    Message message = TextMessage(author: widget.user ?? User(id: "0de4krd0sas-49iecxo203rji", name: 'Demo'), text: textController.text, time: "now", stage: 1);
